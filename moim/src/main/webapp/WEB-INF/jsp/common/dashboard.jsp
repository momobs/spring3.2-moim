    ...
    <div class="page-wrapper">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="${contextPath }">
                        <img src="<c:url value='/asset/img/logo/logo.png'/>" alt="logo" class="logo-default" /> </a>
                        ...
                        <c:choose>
                      		<c:when test="${sessionScope.user ne null }">
		                        <li class="dropdown dropdown-user">
		                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
		                                <img alt="" class="img-circle" src="<c:url value='/asset/img/avatar/avatar.png'/>" />
		                                <span class="username username-hide-on-mobile"> ${sessionScope.user.USER_ID } </span>
		                            ...
		                            <ul class="dropdown-menu dropdown-menu-default">
		                                ...
		                                <li>
		                                    <a href="<c:url value='/common/logout.do'/>"><i class="icon-key"></i> Log Out </a> 
		                                </li>
		                            </ul>
		                        </li>
							</c:when>
							<c:otherwise>
								<li class="dropdown dropdown-user">
		                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
		                                <img alt="" class="img-circle" src="<c:url value='/asset/img/avatar/avatar.png'/>" />
		                                <span class="username username-hide-on-mobile"> unknown </span>
		                                <i class="fa fa-angle-down"></i>
		                            </a>
		                            <ul class="dropdown-menu dropdown-menu-default">
		                                <li>
		                                    <a href="<c:url value='/common/login.do'/>">
