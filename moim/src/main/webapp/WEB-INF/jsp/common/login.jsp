...
<head>
	...
	<link href="<c:url value='/resource/plugins/select2/css/select2.min.css'/>" rel="stylesheet" type="text/css" />
	<link href="<c:url value='/resource/plugins/select2/css/select2-bootstrap.min.css'/>" rel="stylesheet" type="text/css" />
	<!-- PAGE LEVEL PLUGINS: END -->
	<!-- PAGE LEVEL STYLES: START -->
	<link href="<c:url value='/resource/css/pages/user_login.css'/>" rel="stylesheet" type="text/css" />
...
<body class=" login">
	...
	<div class="logo">
		<a href="${contextPath }">
			<img src="<c:url value='/resource/img/common/logo-default.png'/>" alt="" /> 
		</a>
	</div>
	<!-- END LOGO -->
		...
		<form class="login-form" action="${contextPath }/common/login.do" method="post">
			...
			<div class="form-group">
        		...
        		<div class="input-icon"> 
            		...
            		<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="ID" name="username"/> 
            	</div>
    		</div>
    		<div class="form-group">
